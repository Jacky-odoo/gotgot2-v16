...
class LensList(models.Model):
    ...
    treatment_line_ids = fields.One2many('spec.lens.treatment.line', inverse_name='template_treatment_id', string='HCPCS')
    ...
    semi_finish_lens_ids = fields.One2many('product.template',inverse_name= 'template_treatment_id', string='Lens Parameters')
