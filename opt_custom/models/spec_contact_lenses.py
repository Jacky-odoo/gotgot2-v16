...
class ContactLens(models.Model):
    ...
    # name = fields.Many2one('hr.employee', string="Provider", domain="['|', ('doctor','=',True), ('is_outside_doctor','=',True)]")
    outsider_name = fields.Many2one('hr.employee', string="Provider", domain="['|', ('doctor','=',True), ('is_outside_doctor','=',True)]")
