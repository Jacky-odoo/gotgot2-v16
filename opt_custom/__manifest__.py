...
""",
    ...
    'depends': ['base','mail','account','contacts', 'website_sale', 'stock', 'auth_oauth',
                'auth_signup', 'hr_contract', 'calendar', 'base_setup',
    ...
    'assets': {
        'web.assets_backend': [
            "opt_custom/static/src/css/opt_custom.css",
            "opt_custom/static/src/js/attachment_preview.js",
            "opt_custom/static/src/js/field_options.js",
            "opt_custom/static/src/js/force_save_o2m_record.js",
            "opt_custom/static/src/js/web_widget_timepicker.js",
            "opt_custom/static/src/js/search_bar/control_panel_renderer.js",
            "opt_custom/static/src/js/form_view/form_renderer.js",
            "opt_custom/static/src/js/widgets/switch_company_menu.js",
        ],
        'web.assets_frontend': [
            "opt_custom/static/src/js/optical.js",
