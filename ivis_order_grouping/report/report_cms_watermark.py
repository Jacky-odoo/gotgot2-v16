...
class ReportCMS1500New(models.AbstractModel):
    _name = 'report.ivis_order_grouping.report_cms_1500_new'
    _description = 'report.ivis_order_grouping.report_cms_1500_new'

    #Commented by me Zubair Khan
    ...
    def _get_report_values(self, docids, data=None):
        claim_managers = self.env['account.move'].browse(docids)
